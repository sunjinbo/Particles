...
public class OpenGLView extends GLSurfaceView implements GLSurfaceView.Renderer, Runnable {
    private final static String A_POSITION = "a_Position";
    private final static String A_COLOR = "a_Color";
    private static final int LENGTH_OF_PARTICLE = 3; // x, y, z, r, g, b, a
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        final int vertexShaderId = ShaderUtil.compileVertexShader(getContext(), "vertex_particle.glsl");
        final int fragmentShaderId = ShaderUtil.compileFragmentShader(getContext(), "fragment_particle.glsl");
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        GLES20.glVertexAttribPointer(aPositionLocation,3, GLES20.GL_FLOAT, false, 0, mFloatBuffer);
